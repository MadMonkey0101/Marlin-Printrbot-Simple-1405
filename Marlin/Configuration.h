...
#define STRING_SPLASH STRING_VERSION // will be shown during bootup
...
#define CUSTOM_MENDEL_NAME "Printrbot Simple 1405"
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define PROBE_EDGE_OFFSET 5  //Offset inboard from the edge of print area to the line that the probe will measure along (Minumum of 5 is recomended)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,2020.0,96.0}  // default steps per unit for Ultimaker
